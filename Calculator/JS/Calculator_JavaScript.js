...
function Input_Decimal(dot) {
    // this ensures that accidental clicking of the decimal pont
...
function Handle_Operator(Next_Operator) {
    ...
    //Calculator.First_Operand if ti doesn't alrady exist
    const value_of_Input = parseFloat(Display_Value) ;
    //checks if an operator alraedy exists and if Wait_Second_Operand is true,
    ...
    keys.addEventListener('click', (event) => {
        // the target variable is an objest that represents the element
        // that was clicked
        const { target } = event;
